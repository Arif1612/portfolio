...
const About = () => {
    return (
        ...
        <Container>
            ...
            <section>
          {/* main div */}
            <div className="grid md:grid-cols-2 items-center grid-cols-1 gap-4 mx-10 md:m-0">
               {/* left */}
             <div className="w-full mt-10 mr-5  ">
                <h5 className="text-3xl font-bold ">Welcome To My World</h5>
                 <h1 className=" text-4xl  font-bold pt-2 pb-4">Hi, I am <span className="text-6xl text-blue-500">Arif</span></h1>
